...
import Laptop from '../components/portfolio-pg/laptop.jsx';
  ...
  return (
    <>
      <main className="px-6 flex min-h-screen max-w-[1300px] mx-[auto] flex-col items-center justify-between">
        <div className=" w-full absolute top-0 h-screen max-md:min-h-[120vw] md:min-h-[45vw] bg-black" ><div className='w-full h-full max-md:bg-[url(/portfolio-pg/nametxt.svg)] bg-no-repeat bg-center bg-contain'> <Particles /></div><div className='absolute top-0 w-full h-full max-md:bg-[url(/portfolio-pg/nametxt.svg)] bg-no-repeat bg-center bg-contain'/><div className='max-md:hidden w-1/3 h-1/4 absolute bottom-[10px] right-[10px] bg-[url(/portfolio-pg/nametxt.svg)] bg-no-repeat bg-center bg-contain'></div></div>
